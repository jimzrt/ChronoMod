...
{
    char* blowfish_s_init = chrono_binary + 0x39AB38; // A6 0B 31 D1 AC B5 DF 98
    char* blowfish_p_init = chrono_binary + 0x39BB38; // 88 6A 3F 24 D3 08 A3 85
    char* blowfish_key = chrono_binary + 0x3992E8; // BA EC B7 8A EA 25 CA E4
